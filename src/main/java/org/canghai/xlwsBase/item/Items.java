...
public class Items {
    ...
    public static final Item JIN_YIN_HUA = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","jin_yin_hua"))),
            "superior_herb"
    );
    public static final Item HUANG_LIAN = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","huang_lian"))),
            "superior_herb"
    );
    public static final Item CHEN_XIANG = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","chen_xiang"))),
            "superior_herb"
    );
    public static final Item BO_HE = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","bo_he"))),
            "superior_herb"
    );
    public static final Item YU_JIN = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","yu_jin"))),
            "superior_herb"
    );
    public static final Item MA_HUANG = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("superior_herb","ma_huang"))),
            "superior_herb"
    );
    // 仙品药草。
    public static final Item REN_SHEN = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","ren_shen"))),
            "celestial_herb"
    );
    public static final Item HUO_XIANG = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","huo_xiang"))),
            "celestial_herb"
    );
    public static final Item ZHU_SHA = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","zhu_sha"))),
            "celestial_herb"
    );
    public static final Item BAN_XIA = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","ban_xia"))),
            "celestial_herb"
    );
    public static final Item LU_RONG = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","lu_rong"))),
            "celestial_herb"
    );
    public static final Item YUAN_HU = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("celestial_herb","yuan_hu"))),
            "celestial_herb"
    );
    // 稀世药草。
    public static final Item TIAN_SHAN_XUE_LIAN = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","tian_shan_xue_lian"))),
            "rare_herb"
    );
    public static final Item SHOU_WU = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","shou_wu"))),
            "rare_herb"
    );
    public static final Item DONG_CHONG_XIA_CAO = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","dong_chong_xia_cao"))),
            "rare_herb"
    );
    public static final Item LING_ZHI = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","ling_zhi"))),
            "rare_herb"
    );
    public static final Item CONG_RONG = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","cong_rong"))),
            "rare_herb"
    );
    public static final Item XI_LING = register(
            new HerbItem(new Item.Settings().component(Components.HERB_TYPE, new HerbComponent("rare_herb","xi_ling"))),
            "rare_herb"
    );
    // 上品丹药。
    public static final Item HUI_SHEN = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","hui_shen"))),
            "superior_pill"
    );
    public static final Item MING_GONG = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","ming_gong"))),
            "superior_pill"
    );
    public static final Item XU_JIA = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","xu_jia"))),
            "superior_pill"
    );
    public static final Item HUA_FENG = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","hua_feng"))),
            "superior_pill"
    );
    public static final Item YE_MING = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","ye_ming"))),
            "superior_pill"
    );
    public static final Item KANG_SU = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","kang_su"))),
            "superior_pill"
    );
    public static final Item JING_XIN = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","jing_xin"))),
            "superior_pill"
    );
    public static final Item YIN_XIU = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","yin_xiu"))),
            "superior_pill"
    );
    public static final Item CHONG_MING = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","chong_ming"))),
            "superior_pill"
    );
    public static final Item CANG_TI = register(
            new SuperiorPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("superior_pill","cang_ti"))),
            "superior_pill"
    );
    // 仙品丹药
    public static final Item AN_HUN = register(
            new CelestialPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("celestial_pill","an_hun"))),
            "celestial_pill"
    );
    public static final Item QI_XUE = register(
            new CelestialPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("celestial_pill","qi_xue"))),
            "celestial_pill"
    );
    public static final Item ZHUANG_YANG = register(
            new CelestialPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("celestial_pill","zhuang_yang"))),
            "celestial_pill"
    );
    public static final Item YIN_LING = register(
            new CelestialPillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("celestial_pill","yin_ling"))),
            "celestial_pill"
    );
    // 稀世丹药
    public static final Item HUAN_HUN = register(
            new RarePillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("rare_pill","huan_hun"))),
            "rare_pill"
    );
    public static final Item ZHOU_QI = register(
            new RarePillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("rare_pill","zhou_qi"))),
            "rare_pill"
    );
    public static final Item CHONG_YANG = register(
            new RarePillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("rare_pill","chong_yang"))),
            "rare_pill"
    );
    public static final Item ZHOU_LING = register(
            new RarePillItem(new Item.Settings().component(Components.PILL_TYPE, new PillComponent("rare_pill","zhou_ling"))),
            "rare_pill"
    );
    /**
     * 添加静态初始化方法，确保该类被加载。
